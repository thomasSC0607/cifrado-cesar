...
1. Abre la consola y asegurate de estar dentro de la carpeta `cifrado-cesar`
2. Ejecuta `python cesar.py`
3. Elige entre cifrar/descifrar
4. Ingresa la llave (número entero)
5. Ingresa el texto a cifrar o descifrar